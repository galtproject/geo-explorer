...
module.exports = async (extendConfig) => {
  ...
  setInterval(async () => {
    ...
    console.log('newContractsConfig.blockNumber', newContractsConfig.blockNumber, 'serviceInstance.contractsConfig.blockNumber', serviceInstance.contractsConfig.blockNumber);
